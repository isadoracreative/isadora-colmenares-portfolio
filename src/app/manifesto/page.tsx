...
const manifestoSections = [
  ...
  },
  {
    ...
    paragraphs: [
      'Knowledge in books is accessed by a subset of the population: people who can read, want to read, and can accurately interpret text-based meaning. It is a designer\u2019s duty to disseminate information by communicating concepts, theories, and facts through spatial experiences that incorporate text alongside multi-sensory media.',
      'Inspire people with information about topics connected to their interests.',
      'Increase retention through multi-sensory activities.',
      'People observing and interacting with novel subjects have a reaction. Be inspired! Gain knowledge! Fill with emotion!',
      'Ignite a passion in people to act and make a social impact.',
      'Engage the senses to lay the groundwork for nostalgia.',
    ],
  ...
  },
  {
    ...
    paragraphs: [
      'Defeat boredom by providing activities that meaningfully entertain.',
      'Facilitate the creation of memories using subject matter that connects people with other people.',
      'Through shared experiences, people connect and memories are born.',
  ...
  },
  {
    ...
    paragraphs: [
      'Exhibitions and experiences are for all; no human is excluded.',
      'Truly inclusive experiences are created through accessible, universal design.',
      'The benefit of an experience is determined by the needs of the target audience.',
      'Target audiences are selected with intention, based on research and facts.',
      'A great exhibition will be centered around that audience; it will not center the audience around the exhibition.',
      'Above all, the spark should never be lost. Let it rise and fall, dance and falter, but never let it miss the target.',
      'A great experience brings the spark to the audience. It remains embedded there, now an ember waiting to burst into a bouquet of wild new ideas.',
    ],
