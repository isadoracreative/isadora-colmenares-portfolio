...
export default function Footer() {
  ...
  return (
    <footer className="w-full pt-24">
      {/*
        Figma footer (5:6548): 96px white space above the green band, then
        py-9 (36px) inside the band. Horizontal padding mirrors the layout grid:
          xs      → px-4  (16px)
          sm / md → px-6  (24px)
          lg+     → px-9  (36px)
      */}
      <div className="w-full bg-core-green px-4 sm:px-6 lg:px-9 py-9">
