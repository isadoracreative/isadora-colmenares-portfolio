...
import imgEllipse1 from "./c4734a8be37f42086922c5b886f874d8c58e2bc7.png";
import imgEllipse2 from "./6a578ae013fd1bed26c8675b9dedbfc3991cbd1a.png";
import imgEllipse3 from "./bcb69ed1b6fb2d2ada3fb64dbc243faa2abb0498.png";
import imgEllipse4 from "./c6f09fe903df3ee0a3a2f1c9f50124613176d6ac.png";
import imgEllipse5 from "./282a578373ff49899f645667a51061713d95ad3f.png";
import imgEllipse6 from "./f292185dd9df25681733caf427837a4deb2e0745.png";
  ...
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 text-[#222526] w-full">
      ...
      <ul className="block font-['Karla:Regular',sans-serif] font-normal leading-[0] list-disc relative shrink-0 text-[16px] w-full">
        ...
        <li className="ms-[24px]">
          <span className="leading-[normal]">SketchUp (Basic)</span>
        </li>
      </ul>
    </div>
  );
...
function Ellipse() {
  return (
    <div className="pointer-events-none relative rounded-[134px] shrink-0 size-[67px]">
      <img alt="" className="absolute inset-0 max-w-none object-cover rounded-[134px] size-full" src={imgEllipse1} />
      <div aria-hidden className="absolute border border-[#eceeee] border-solid inset-0 rounded-[134px]" />
    </div>
  );
}
...
function Ellipse1() {
  return (
    <div className="pointer-events-none relative rounded-[134px] shrink-0 size-[67px]">
      <img alt="" className="absolute inset-0 max-w-none object-cover rounded-[134px] size-full" src={imgEllipse2} />
      <div aria-hidden className="absolute border border-[#eceeee] border-solid inset-0 rounded-[134px]" />
    </div>
  );
}
...
function Ellipse2() {
  return (
    <div className="pointer-events-none relative rounded-[134px] shrink-0 size-[67px]">
      <img alt="" className="absolute inset-0 max-w-none object-cover rounded-[134px] size-full" src={imgEllipse3} />
      <div aria-hidden className="absolute border border-[#eceeee] border-solid inset-0 rounded-[134px]" />
    </div>
  );
}
...
function Ellipse3() {
  return (
    <div className="pointer-events-none relative rounded-[134px] shrink-0 size-[67px]">
      <img alt="" className="absolute inset-0 max-w-none object-cover rounded-[134px] size-full" src={imgEllipse4} />
      <div aria-hidden className="absolute border border-[#eceeee] border-solid inset-0 rounded-[134px]" />
    </div>
  );
}
...
function Ellipse4() {
  return (
    <div className="pointer-events-none relative rounded-[134px] shrink-0 size-[67px]">
      <img alt="" className="absolute inset-0 max-w-none object-cover rounded-[134px] size-full" src={imgEllipse5} />
      <div aria-hidden className="absolute border border-[#eceeee] border-solid inset-0 rounded-[134px]" />
    </div>
  );
}
...
function Ellipse5() {
  return (
    <div className="relative rounded-[134px] shrink-0 size-[67px]">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[134px] size-full" src={imgEllipse6} />
    </div>
  );
}
...
function FooterContent() {
  return (
    <div className="[word-break:break-word] content-stretch flex font-['Karla:Regular',sans-serif] font-normal items-start justify-between leading-[0] max-w-[1440px] overflow-clip relative shrink-0 text-[#222526] text-[14px] w-full whitespace-nowrap" data-name="footer content">
      <Links />
      <div className="flex flex-col justify-end relative shrink-0">
  ...
  return (
    <div className="bg-[#06d6a0] relative shrink-0 w-full" data-name="wrapper">
      <div className="flex flex-col items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-center p-[36px] relative size-full">
          <FooterContent />
        </div>
      </div>
    </div>
...
function MainAndFooter() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col items-center left-0 pt-[96px] top-0 w-[1280px]" data-name="main and footer">
      <div className="bg-white content-stretch flex flex-col gap-[48px] items-center relative shrink-0 w-[1280px]" data-name="content - about">
        <Layout />
        <FluidContainer />
      ...
      <div className="content-stretch flex flex-col items-center max-w-[1536px] min-w-[1280px] pt-[96px] relative shrink-0 w-full" data-name="Footer">
        <Wrapper />
      </div>
    </div>
  );
...
function Content() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between max-w-[1440px] min-w-px relative" data-name="content">
...
export default function ViewportXl2Xl() {
  return (
    <div className="relative size-full" data-name="viewport xl-2xl">
      <MainAndFooter />
      <div className="absolute bg-white content-stretch flex items-center justify-center left-0 max-w-[1536px] min-w-[1280px] pl-[36px] pr-[24px] top-0 w-[1280px]" data-name="header nav">
