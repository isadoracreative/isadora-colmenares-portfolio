...
function HeaderImage() {
  return (
    <div className="relative rounded-[2px] shrink-0 size-[130px]" data-name="header image">
...
function Header() {
  return (
    <div className="content-stretch flex gap-[24px] items-start relative shrink-0 w-full" data-name="header">
      <HeaderImage />
      <Frame />
    </div>
  );
...
function Layout() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0 w-[592px]" data-name="layout">
      <Header />
    </div>
  );
}
...
function Layout1() {
  return (
    <div className="[word-break:break-word] gap-x-[36px] gap-y-[24px] grid grid-cols-[repeat(2,minmax(0,1fr))] grid-rows-[repeat(3,fit-content(100%))] relative shrink-0 w-full" data-name="layout">
      <About3 />
      <About4 />
      <About5 />
      <About6 />
...
function SkillsAndExperience() {
  return (
    <div className="content-stretch flex flex-col gap-[36px] items-center relative shrink-0 w-[592px]" data-name="skills and experience">
      <Heading2 />
      <Overview />
    </div>
  );
...
function Layout2() {
  return (
    <div className="[word-break:break-word] content-stretch flex gap-[24px] items-start relative shrink-0 w-full" data-name="layout">
      <About10 />
      <About11 />
    </div>
  );
...
function Layout3() {
  return (
    <div className="gap-x-[24px] gap-y-[36px] grid grid-cols-[repeat(2,minmax(0,1fr))] grid-rows-[repeat(3,fit-content(100%))] relative shrink-0 w-full" data-name="layout">
      <Frame29 />
      <Frame32 />
      <Frame35 />
      <Frame38 />
...
function Links() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0" data-name="links">
...
function Container() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col font-['Karla:Regular',sans-serif] font-normal gap-[24px] items-start leading-[0] max-w-[720px] relative shrink-0 text-[#222526] text-[14px] w-full whitespace-nowrap" data-name="container">
      <Links />
      <div className="flex flex-col justify-end relative shrink-0">
...
function Wrapper() {
  return (
    <div className="bg-[#06d6a0] relative shrink-0 w-full" data-name="wrapper">
      <div className="flex flex-col items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-center px-[24px] py-[36px] relative size-full">
          <Container />
        </div>
      </div>
    </div>
...
function MainAndFooter() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col gap-[24px] items-center left-0 pt-[72px] top-0 w-[640px]" data-name="main and footer">
      <div className="bg-white content-stretch flex flex-col gap-[36px] items-center relative shrink-0 w-[640px]" data-name="content - about">
        <Layout />
        <FluidContainer />
      ...
      <div className="content-stretch flex flex-col items-center max-w-[768px] min-w-[640px] pt-[96px] relative shrink-0 w-full" data-name="Footer">
        <Wrapper />
      </div>
    </div>
  );
...
export default function ViewportSmMd() {
  return (
    <div className="relative size-full" data-name="viewport sm-md">
      <MainAndFooter />
      <div className="absolute content-stretch flex items-center left-0 max-w-[768px] top-0 w-[640px]" data-name="header nav">
        <NavBarAndMenu />
      </div>
    </div>
  );
