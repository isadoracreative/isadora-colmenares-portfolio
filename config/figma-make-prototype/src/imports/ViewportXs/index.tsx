...
function HeaderImage() {
  return (
    <div className="aspect-[288/288] relative rounded-[2px] shrink-0 w-full" data-name="header image">
...
function ClientAndProject() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Client and project">
      <p className="[word-break:break-word] font-['Montserrat:Semibold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#222526] text-[32px] w-full">Isadora Colmenares</p>
    </div>
  );
}
...
function ClientAndProject1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Client and project">
      <p className="[word-break:break-word] font-['Montserrat:Semibold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#222526] text-[22px] w-full">About</p>
    </div>
  );
}
...
function About() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[8px] items-start leading-[normal] relative shrink-0 text-[#222526] w-full" data-name="about">
      <p className="font-['Montserrat:Semibold',sans-serif] not-italic relative shrink-0 text-[18px] w-full">{`Experiential Design & Systemic Hierarchy`}</p>
...
function About1() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[8px] items-start leading-[normal] relative shrink-0 text-[#222526] w-full" data-name="about">
      <p className="font-['Montserrat:Semibold',sans-serif] not-italic relative shrink-0 text-[18px] w-full">{`Cross-Disciplinary Translation & Execution`}</p>
...
function About2() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[8px] items-start leading-[normal] relative shrink-0 text-[#222526] w-full" data-name="about">
      <p className="font-['Montserrat:Semibold',sans-serif] not-italic relative shrink-0 text-[18px] w-full">Multi-Dimensional Creative Perspective</p>
...
function HeaderImage1() {
  return (
    <div className="aspect-[288/288] justify-self-stretch relative rounded-[2px] shrink-0" data-name="header image">
...
function HeaderImage2() {
  return (
    <div className="aspect-[332.5/332.5] justify-self-stretch relative rounded-[2px] shrink-0" data-name="header image">
      <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[2px]">
...
function Frame11() {
  return (
    <div className="gap-x-[16px] gap-y-[16px] grid grid-cols-[repeat(2,minmax(0,1fr))] grid-rows-[repeat(2,fit-content(100%))] relative shrink-0 w-full">
      <HeaderImage1 />
      <HeaderImage2 />
      <HeaderImage3 />
      <HeaderImage4 />
...
function Layout() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0 w-[288px]" data-name="layout">
      <Header />
    </div>
  );
}
...
function ClientAndProject2() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Client and project">
      <p className="[word-break:break-word] font-['Montserrat:Semibold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#222526] text-[24px] w-full">{`Core Skills & Expertise`}</p>
    </div>
  );
}
...
function Frame15() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 text-[#222526] w-full">
      <p className="font-['Montserrat:Semibold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[18px] w-full">{`Experience & Spatial Design`}</p>
...
function About3() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full" data-name="about">
...
function Frame16() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 text-[#222526] w-full">
      <p className="font-['Montserrat:Semibold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[18px] w-full">{`Research & Methods`}</p>
      <ul className="block font-['Karla:Regular',sans-serif] font-normal leading-[0] list-disc relative shrink-0 text-[16px] w-full">
        <li className="mb-0 ms-[24px]">
...
function Frame17() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 text-[#222526] w-full">
      <p className="font-['Montserrat:Semibold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[18px] w-full">{`Technologies & Frameworks`}</p>
      <ul className="block font-['Karla:Regular',sans-serif] font-normal leading-[0] list-disc relative shrink-0 text-[16px] w-full">
        <li className="mb-0 ms-[24px]">
...
function Frame18() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 text-[#222526] w-full">
      <p className="font-['Montserrat:Semibold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[18px] w-full">{`Tools & Software`}</p>
      <ul className="block font-['Karla:Regular',sans-serif] font-normal leading-[0] list-disc relative shrink-0 text-[16px] w-full">
        <li className="mb-0 ms-[24px]">
...
function Frame19() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 text-[#222526] w-full">
      <p className="font-['Montserrat:Semibold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[18px] w-full">Emerging Tech</p>
      <ul className="block font-['Karla:Regular',sans-serif] font-normal leading-[0] list-disc relative shrink-0 text-[16px] w-full">
        <li className="mb-0 ms-[24px]">
...
function Frame20() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 text-[#222526] w-full">
      <p className="font-['Montserrat:Semibold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[18px] w-full">Languages</p>
      <ul className="block font-['Karla:Regular',sans-serif] font-normal leading-[0] list-disc relative shrink-0 text-[16px] w-full">
        <li className="mb-0 ms-[24px]">
...
function Layout1() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full" data-name="layout">
      <About3 />
      <About4 />
      <About5 />
      <About6 />
...
function SkillsAndExperience() {
  return (
    <div className="content-stretch flex flex-col gap-[36px] items-center relative shrink-0 w-[288px]" data-name="skills and experience">
      <Heading2 />
      <Overview />
    </div>
  );
...
function FluidContainer() {
  return (
    <div className="bg-[#f7f8f8] content-stretch flex flex-col items-center py-[36px] relative shrink-0 w-full" data-name="fluid container">
      <SkillsAndExperience />
    </div>
  );
}
...
function ClientAndProject3() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Client and project">
      <p className="[word-break:break-word] font-['Montserrat:Semibold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#222526] text-[24px] w-full">Work Experience Highlights</p>
    </div>
  );
}
...
function Frame14() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start leading-[normal] relative shrink-0 w-full">
      <p className="font-['Montserrat:Semibold',sans-serif] not-italic relative shrink-0 text-[#222526] text-[18px] w-full">Contract Experience Designer</p>
...
function Frame21() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start leading-[normal] relative shrink-0 w-full">
      <p className="font-['Montserrat:Semibold',sans-serif] not-italic relative shrink-0 text-[#222526] text-[18px] w-full">Experience Design Manager</p>
...
function Frame23() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start leading-[normal] relative shrink-0 w-full">
      <p className="font-['Montserrat:Semibold',sans-serif] not-italic relative shrink-0 text-[#222526] text-[18px] w-full">UX Design Lead</p>
...
function Frame24() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start leading-[normal] relative shrink-0 w-full">
      <p className="font-['Montserrat:Semibold',sans-serif] not-italic relative shrink-0 text-[#222526] text-[18px] w-full">{`Principal UX Designer & UX Engineering Lead`}</p>
...
function Frame25() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start leading-[normal] relative shrink-0 w-full">
      <p className="font-['Montserrat:Semibold',sans-serif] not-italic relative shrink-0 text-[#222526] text-[18px] w-full">Senior Designer</p>
...
function Frame26() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start leading-[normal] relative shrink-0 w-full">
      <p className="font-['Montserrat:Semibold',sans-serif] not-italic relative shrink-0 text-[#222526] text-[18px] w-full">Graphic Designer</p>
...
function About9() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full" data-name="about">
      <Frame3 />
      <Frame4 />
      <Frame5 />
      <Frame6 />
...
function Frame13() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full">
      <div className="relative rounded-[2px] shrink-0 w-full" data-name="button outline">
        ...
        <div className="flex flex-row items-center justify-center size-full">
          <div className="[word-break:break-word] content-stretch flex gap-[8px] items-center justify-center leading-[0] px-[16px] py-[8px] relative size-full text-[#3a4041] text-[14px]">
            <div className="flex flex-col font-['Font_Awesome_7_Brands:Regular',sans-serif] justify-center not-italic relative shrink-0 size-[14px] text-center">
              <p className="leading-[normal]">linkedin</p>
            </div>
            <div className="flex flex-col font-['Karla:Regular',sans-serif] font-normal justify-center relative shrink-0 whitespace-nowrap">
      ...
      <div className="relative rounded-[2px] shrink-0 w-full" data-name="button outline">
        ...
        <div className="flex flex-row items-center justify-center size-full">
          <div className="[word-break:break-word] content-stretch flex gap-[8px] items-center justify-center leading-[0] px-[16px] py-[8px] relative size-full text-[#3a4041] text-[14px]">
            <div className="flex flex-col font-['Font_Awesome_7_Sharp:Light',sans-serif] justify-center not-italic relative shrink-0 size-[14px] text-center">
...
function ClientAndProject4() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Client and project">
      <p className="[word-break:break-word] font-['Montserrat:Semibold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#222526] text-[24px] w-full">Key Accolades</p>
    </div>
  );
}
...
function Frame10() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 text-[18px] w-full">
      <p className="font-['Montserrat:Semibold',sans-serif] not-italic relative shrink-0 text-[#222526] w-full">Inhouse Design Award</p>
      <p className="font-['Karla:Medium',sans-serif] font-medium relative shrink-0 text-[#6a7576] w-full">Graphic Design USA</p>
    </div>
  );
}
...
function Frame12() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 text-[18px] w-full">
      <p className="font-['Montserrat:Semibold',sans-serif] not-italic relative shrink-0 text-[#222526] w-full">Platinum Star Award</p>
      <p className="font-['Karla:Medium',sans-serif] font-medium relative shrink-0 text-[#6a7576] w-full">Aon</p>
    </div>
  );
}
...
function ClientAndProject5() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Client and project">
      <p className="[word-break:break-word] font-['Montserrat:Semibold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#222526] text-[24px] w-full">Recommendations</p>
    </div>
  );
}
...
function Layout3() {
  return (
    <div className="content-stretch flex flex-col gap-[36px] items-start relative shrink-0 w-full" data-name="layout">
      <Frame29 />
      <Frame32 />
      <Frame35 />
      <Frame38 />
...
function Links() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 whitespace-nowrap" data-name="links">
...
function Container() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col font-['Karla:Regular',sans-serif] font-normal gap-[24px] items-start leading-[0] max-w-[288px] relative shrink-0 text-[#222526] text-[14px] w-full" data-name="container">
      <Links />
      <div className="flex flex-col justify-end min-w-full relative shrink-0 w-[min-content]">
...
function MainAndFooter() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col gap-[24px] items-center left-0 pt-[72px] top-0 w-[320px]" data-name="main and footer">
      <div className="bg-white content-stretch flex flex-col gap-[24px] items-center relative shrink-0 w-[320px]" data-name="content - about">
        <Layout />
        <FluidContainer />
      ...
      <div className="content-stretch flex flex-col items-center max-w-[320px] min-w-[320px] pt-[96px] relative shrink-0 w-full" data-name="Footer">
        <Wrapper />
      </div>
    </div>
  );
...
function Icon() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-[46px] items-center justify-center min-w-px relative" data-name="icon">
      <div className="[word-break:break-word] flex flex-col font-['Font_Awesome_7_Sharp:Light',sans-serif] justify-end leading-[0] not-italic relative shrink-0 text-[#222526] text-[16px] text-left whitespace-nowrap">
        <p className="leading-[normal]">bars</p>
      </div>
    </div>
  );
}
...
function MainMenu() {
  return (
    <button className="content-stretch cursor-pointer flex h-full items-center relative shrink-0 w-[32px]" data-name="main menu">
      <Icon />
    </button>
  );
}
...
function MenuAndSiteTitle() {
  return (
    <div className="content-stretch flex flex-[1_0_0] h-full items-center justify-between min-w-px relative" data-name="menu and site title">
      <div className="[word-break:break-word] flex flex-col font-['Montserrat:SemiBold',sans-serif] font-semibold justify-end leading-[0] relative shrink-0 text-[#222526] text-[14px] whitespace-nowrap">
...
function Content() {
  return (
    <div className="bg-white h-[48px] relative shrink-0 w-full z-[2]" data-name="content">
      <div aria-hidden className="absolute border-[#d4d8d8] border-b border-solid inset-[0_0_-1px_0] pointer-events-none" />
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center justify-between pl-[16px] pr-[12px] relative size-full">
          <MenuAndSiteTitle />
        </div>
      </div>
    </div>
...
function NavBarAndMenu() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col isolate items-end min-w-px relative" data-name="nav bar and menu">
      <Content />
    </div>
  );
}

export default function ViewportXs() {
  return (
    <div className="relative size-full" data-name="viewport xs">
      <MainAndFooter />
      <div className="absolute content-stretch flex items-center left-0 top-0 w-[320px]" data-name="header nav">
        <NavBarAndMenu />
      </div>
    </div>
  );
