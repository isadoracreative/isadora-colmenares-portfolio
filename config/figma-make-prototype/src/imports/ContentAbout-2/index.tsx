...
function HeaderImage() {
  return (
    <div className="relative rounded-[2px] shrink-0 size-[275px]" data-name="header image">
...
function Header() {
  return (
    <div className="content-stretch flex gap-[36px] items-start relative shrink-0 w-[1000px]" data-name="header">
      <HeaderImage />
      <Frame />
    </div>
  );
...
function Layout() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0 w-[1208px]" data-name="layout">
      <Header />
    </div>
  );
}
...
function Heading2() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-[1000px]" data-name="heading">
      <ClientAndProject2 />
      <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="divider short">
        <div className="flex-[1_0_0] h-0 max-w-[72px] min-w-px relative" data-name="divider short">
          <div className="absolute inset-[-1px_0_0_0]">
...
function Overview() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[1000px]" data-name="overview">
      <Layout1 />
    </div>
  );
}
...
function SkillsAndExperience() {
  return (
    <div className="content-stretch flex flex-col gap-[36px] items-center relative shrink-0 w-[1208px]" data-name="skills and experience">
      <Heading2 />
      <Overview />
    </div>
  );
...
function Frame31() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full">
      ...
      <p className="[word-break:break-word] flex-[1_0_0] font-['Karla:Regular',sans-serif] font-normal leading-[normal] min-w-px relative text-[#6a7576] text-[16px]">– Meera Butler, Senior Director of Product Management at Korn Ferry</p>
    </div>
  );
}
...
function Frame29() {
  return (
    <div className="content-stretch flex items-start justify-self-stretch relative self-stretch shrink-0">
...
function Layout3() {
  return (
    <div className="gap-x-[36px] gap-y-[36px] grid grid-cols-[repeat(3,minmax(0,1fr))] grid-rows-[repeat(2,fit-content(100%))] relative shrink-0 w-full" data-name="layout">
      <Frame29 />
      <Frame32 />
      <Frame35 />
      <Frame38 />
...
export default function ContentAbout() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[48px] items-center relative size-full" data-name="content - about">
      <Layout />
      <FluidContainer />
